        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">All About Languages</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Learning Center</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Language</li>
                        </ol>
                    </nav>
                </div>
            </div>
          ...
          <div class="row g-4">
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="service-item text-center pt-3">
                <div class="p-4">
                  <i class="fas fa-3x fa-sort-alpha-down text-warning mb-4"></i>
                  <h5 class="mb-3">Phonics</h5>
                  <p>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="service-item text-center pt-3">
                <div class="p-4">
                  <i class="fa fa-3x fa-book-reader text-warning mb-4"></i>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
              <div class="service-item text-center pt-3">
                <div class="p-4">
                  <i class="fas fa-3x fa-bookmark text-warning mb-4"></i>
                  <h5 class="mb-3">Vocabulary</h5>
                  <p>
                    Diam elitr kasd sed at elitr sed ipsum justo dolor sed clita
                    amet diam
                  </p>
        ...
        <div class="container">
          <div class="row g-5 mb-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <h1 class="mb-4">Learn English Language</h1>
              <p class="mb-4">
