      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <a class="btn btn-link" href="start-class">Start a Class</a>
            <a class="btn btn-link" href="contact">Contact Us</a>
            <a class="btn btn-link" href="coding">About Coding</a>
            <a class="btn btn-link" href="terms">Terms & Condition</a>
          </div>
          <div class="col-lg-3 col-md-6">
            <h4 class="text-white mb-3">Contact</h4>
            <p class="mb-2">
              <i class="fa fa-map-marker-alt me-3"></i>1 Ajayi Close,
              Lagos, Nigeria
            </p>
            <p class="mb-2">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p>Join our subscribers list to get latest updates and special offers directly without stress</p>
        ...
        <div class="copyright">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
              ...
              Designed By
              <a class="border-bottom" href="https://yourtechie.com.ng"
                >Your Techie</a
              >
            </div>
            <div class="col-md-6 text-center text-md-end">
              <div class="footer-menu">
                <a href="home">Home</a>
                <a href="start-class">Start Class</a>
