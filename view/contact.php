        ...
        <div class="container">
            ...
            <?php if(isset($_GET['error'])){?>
    			...
    			<div class="alert alert-success">
    				<strong>SUCCESS ! <?php echo $success; ?></strong>
    			</div>
            <?php } ?>

            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-warning px-3">Contact Us</h6>
                <h1 class="mb-5">Contact For Any Query</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">You can easily contact us by filling the form below. Be rest assured you will get a response on your enquiry.</p>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">1 Ajayi Close, Lagos, Nigeria</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-dark" style="width: 50px; height: 50px;">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">+234 810 196 3400</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">yourtechiekids@gmail.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form class="" action="send" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-warning w-100 py-3" type="submit" name="send">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
